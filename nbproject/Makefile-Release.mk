...
${OBJECTDIR}/Gaussian.o: Gaussian.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gaussian.o Gaussian.cpp

${OBJECTDIR}/LinearRegressor.o: LinearRegressor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearRegressor.o LinearRegressor.cpp

${OBJECTDIR}/MultipleRegressor.o: MultipleRegressor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultipleRegressor.o MultipleRegressor.cpp

${OBJECTDIR}/PolyNomialRegressor.o: PolyNomialRegressor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PolyNomialRegressor.o PolyNomialRegressor.cpp
